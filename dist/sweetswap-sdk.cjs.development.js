...
(function (ChainId) {
  ...
  ChainId[ChainId["OKTMAIN"] = 66] = "OKTMAIN";
...
var INIT_CODE_HASHES = (_INIT_CODE_HASHES = {}, _INIT_CODE_HASHES[exports.ChainId.MAINNET] = '0x1ae685a06ad758dcd2c4191b790c1c3283d1d56d917bc1bad7328c2a4f2ab5a0', _INIT_CODE_HASHES[exports.ChainId.ROPSTEN] = '0x1ae685a06ad758dcd2c4191b790c1c3283d1d56d917bc1bad7328c2a4f2ab5a0', _INIT_CODE_HASHES[exports.ChainId.RINKEBY] = '0x1ae685a06ad758dcd2c4191b790c1c3283d1d56d917bc1bad7328c2a4f2ab5a0', _INIT_CODE_HASHES[exports.ChainId.GÖRLI] = '0x1ae685a06ad758dcd2c4191b790c1c3283d1d56d917bc1bad7328c2a4f2ab5a0', _INIT_CODE_HASHES[exports.ChainId.KOVAN] = '0xe3a2d8b356e0265479117bb262881a7c7c690a1cf7392d0ab59e30d5134cbe06', _INIT_CODE_HASHES[exports.ChainId.HECOMAIN] = '0x1ae685a06ad758dcd2c4191b790c1c3283d1d56d917bc1bad7328c2a4f2ab5a0', _INIT_CODE_HASHES[exports.ChainId.HECOTEST] = '0x3990fda9ab516b83a46ecb97d0e6916dcfc56eae1ae253e0b7a74b0412065af1', _INIT_CODE_HASHES[exports.ChainId.BIANMAIN] = '0x1ae685a06ad758dcd2c4191b790c1c3283d1d56d917bc1bad7328c2a4f2ab5a0', _INIT_CODE_HASHES[exports.ChainId.BIANTEST] = '0x1ae685a06ad758dcd2c4191b790c1c3283d1d56d917bc1bad7328c2a4f2ab5a0', _INIT_CODE_HASHES[exports.ChainId.OKTEST] = '0xa9252a257da1cf1409d57be07f4bffae98731dad512dd65b33f8ef8a999d92c5', _INIT_CODE_HASHES[exports.ChainId.OKTMAIN] = '0xa9252a257da1cf1409d57be07f4bffae98731dad512dd65b33f8ef8a999d92c5', _INIT_CODE_HASHES);
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.MAINNET] = '', _FACTORY_ADDRESS[exports.ChainId.ROPSTEN] = '', _FACTORY_ADDRESS[exports.ChainId.RINKEBY] = '', _FACTORY_ADDRESS[exports.ChainId.GÖRLI] = '', _FACTORY_ADDRESS[exports.ChainId.KOVAN] = '0x54038C23b72b01eeDBaF4AE4C098D329FB2D32f1', _FACTORY_ADDRESS[exports.ChainId.HECOMAIN] = '0x76854443c1FC36Bbad8E9Ae361ED415dD673640f', _FACTORY_ADDRESS[exports.ChainId.HECOTEST] = '0xe2c1453d83f11Fa331a3Ece2D6E174F795071639', _FACTORY_ADDRESS[exports.ChainId.BIANMAIN] = '0x76854443c1FC36Bbad8E9Ae361ED415dD673640f', _FACTORY_ADDRESS[exports.ChainId.BIANTEST] = '0x76854443c1FC36Bbad8E9Ae361ED415dD673640f', _FACTORY_ADDRESS[exports.ChainId.OKTEST] = '0xbb362F4213eF1c0114158778c85861c8cdc0a66e', _FACTORY_ADDRESS[exports.ChainId.OKTMAIN] = '0xbb362F4213eF1c0114158778c85861c8cdc0a66e', _FACTORY_ADDRESS);
...
var Pair = /*#__PURE__*/function () {
  ...
  // }
  function Pair(pairAddr, tokenAmountA, tokenAmountB) {
    var tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
    ? [tokenAmountA, tokenAmountB] : [tokenAmountB, tokenAmountA];
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, pairAddr, 18, 'GLP:' + tokenAmounts[0].token.symbol + '-' + tokenAmounts[1].token.symbol, 'GoSwap LP Token');
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    pairs.every(function (pair) {
      return _this.pairsAddress.push(pair.pairAddr);
    });
    this.pairs = pairs;
    this.path = path;
  ...
  currentPairs, originalAmountIn, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountOut.token.equals(tokenOut) && currentPairs.length > 2) {
        ...
        if (Ea < Eb) {
          sortedInsert(bestTrades, new Trade(new Route([].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut), originalAmountIn, exports.TradeType.EXACT_INPUT, getOptimalAmount(Ea, Eb), getAmountOut(getOptimalAmount(Ea, Eb), Ea, Eb)), maxNumResults, arbComparator, tradeFilter);
        }
      } else if (maxHops > 1 && pairs.length > 1) {
        var pairsExcludingThisPair = pairs.slice(0, i).concat(pairs.slice(i + 1, pairs.length)); // otherwise, consider all the other paths that lead from this token as long as we have not exceeded maxHops

        Trade.findArb(pairsExcludingThisPair, amountOut, currencyOut, {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    switch (trade.tradeType) {
      case exports.TradeType.EXACT_INPUT:
        if (etherIn) {
          methodName = useFeeOnTransfer ? 'swapExactHTForTokensSupportingFeeOnTransferTokens' : 'swapExactHTForTokens'; // (uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = useFeeOnTransfer ? 'swapExactTokensForHTSupportingFeeOnTransferTokens' : 'swapExactTokensForHT'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
      ...
      case exports.TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          methodName = 'swapHTForExactTokens'; // (uint amountOut, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = 'swapTokensForExactHT'; // (uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
...
exports.Trade = Trade;
exports.WETH = WETH;
exports.arbComparator = arbComparator;
exports.currencyEquals = currencyEquals;
exports.inputOutputComparator = inputOutputComparator;
exports.tradeComparator = tradeComparator;
exports.tradeFilter = tradeFilter;
//# sourceMappingURL=sweetswap-sdk.cjs.development.js.map
